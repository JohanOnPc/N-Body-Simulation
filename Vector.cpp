...
VectorF::VectorF() : _vec{ _mm_set_ps(0.f, 0.f, 0.f, 0.f) } {}
...
VectorD::VectorD() : _vec{ _mm256_set_pd(0.0, 0.0, 0.0, 0.0) } {}

VectorD::VectorD(double x, double y) : _vec{ _mm256_set_pd(0.0, 0.0, y, x) } {}

VectorD::VectorD(double x, double y, double z) : _vec{ _mm256_set_pd(0.0, z, y, x) } {}
...
double VectorD::LenghtSquared() const
{
	__m256d _squared = _mm256_mul_pd(_vec, _vec);
	__m128d _high = _mm256_extractf128_pd(_squared, 1);
	__m128d _low = _mm256_castpd256_pd128(_squared);
